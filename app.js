          ...
          <details class="accordion">
            ...
            <div class="accordion-body">
              ...
              <table class="protocol-table">
                ...
                <tr>
                  <td><strong>Bariatric Surgery</strong><br>• RYGB<br>• Sleeve Gastrectomy<br>• Gastric Band<br>• BPD/DS<br>• Mini Gastric Bypass<br>• Gastric balloon</td>
                  <td>&lt;12 months</td>
                  <td><a href="#macro-1" class="tag blue">Macro 1</a></td>
                  <td>• Check SCR for surgery date<br>• If timing unclear → hold + email<br>• Add tag: <span class="tag orange">Pending Customer Response</span></td>
                  <td><strong>Reject</strong> if &lt;12 months<br><br><strong>Prescribe</strong> if ≥12 months</td>
                </tr>
                <tr>
                  <td><strong>Cholecystectomy</strong><br>(gallbladder removal)</td>
                  <td>&lt;12 months</td>
                  <td><a href="#macro-1" class="tag blue">Macro 1</a></td>
                  <td>• Check SCR for surgery date<br>• If timing unclear → hold + email<br>• Add tag: <span class="tag orange">Pending Customer Response</span></td>
                  <td><strong>Reject</strong> if &lt;12 months<br><br><strong>Prescribe</strong> if ≥12 months</td>
                ...
                <tr>
                  ...
                  <td>&lt;3 months<br><strong>OR</strong><br>On repeat list</td>
                  <td><a href="#macro-1" class="tag blue">Macro 1</a></td>
                  <td>• Check acute meds (last 3 months)<br>• Check repeat medication list<br>• If on repeat list → <strong>reject immediately</strong><br>• If timing unclear → hold + email</td>
                  <td><strong>Reject</strong> if prescribed within 3 months or on repeat list</td>
                </tr>
                <tr>
                  <td><strong>Oral diabetic meds</strong><br>• Sulfonylureas<br>• SGLT2 inhibitors<br>• DPP-4 inhibitors<br>• Thiazolidinediones</td>
                  <td>&lt;3 months<br><strong>OR</strong><br>On repeat list</td>
                  <td><a href="#macro-1" class="tag blue">Macro 1</a></td>
                  <td>• Check acute meds (last 3 months)<br>• Check repeat medication list<br>• If on repeat list → <strong>reject immediately</strong><br>• If timing unclear → hold + email</td>
                  <td><strong>Reject</strong> if prescribed within 3 months or on repeat list</td>
                ...
                <tr>
                  <td><strong>Narrow Therapeutic Index meds</strong><br>• Amiodarone<br>• Carbamazepine<br>• Ciclosporin<br>• Clozapine<br>• Digoxin<br>• Lithium<br>• Warfarin<br>• Others (see full list)</td>
                  <td>&lt;3 months<br><strong>OR</strong><br>On repeat list</td>
                  <td><a href="#macro-1" class="tag blue">Macro 1</a></td>
                  <td>• Check acute meds (last 3 months)<br>• Check repeat medication list<br>• If on repeat list → <strong>reject immediately</strong><br>• If timing unclear → hold + email</td>
                  <td><strong>Reject</strong> if prescribed within 3 months or on repeat list</td>
                ...
                <tr>
                  <td><strong>Orlistat</strong><br>• Alli<br>• Xenical</td>
                  <td>&lt;1 month</td>
                  <td><a href="#macro-1" class="tag blue">Macro 1</a></td>
                  <td>• Check SCR for recent Orlistat<br>• If timing unclear → hold + email<br>• Add tag: <span class="tag orange">Pending Customer Response</span></td>
                  <td><strong>Reject</strong> if &lt;1 month<br><br>Concurrent use contraindicated</td>
                </tr>
              </table>
            ...
            <div class="accordion-body">
              ...
              <table class="protocol-table">
                ...
                <tr>
                  ...
                  <td>• Check SCR for cholecystectomy evidence<br>• If no evidence → hold + email<br>• Add tag: <span class="tag orange">Pending Customer Response</span></td>
                  <td>Ask if patient had cholecystectomy (gallbladder removal surgery)</td>
                  <td><strong>Reject</strong> if no cholecystectomy<br><br><strong>Prescribe</strong> if cholecystectomy confirmed</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>• Check SCR for HF stage<br>• If stage unclear → hold + email<br>• Add tag: <span class="tag orange">Pending Customer Response</span></td>
                  <td>Request latest cardiology letter stating:<br>• HF stage, OR<br>• Confirmation if fit for GLP-1</td>
                  <td><strong>Reject</strong> if Stage IV<br><br><strong>Prescribe</strong> if Stage I, II, or III</td>
                </tr>
                <tr>
                  <td><strong>Chronic Kidney Disease (CKD)</strong></td>
                  <td><a href="#macro-5" class="tag blue">Macro 5</a></td>
                  <td>• Check SCR for eGFR or CKD stage<br>• If eGFR/stage unclear → hold + email<br>• Add tag: <span class="tag orange">Pending Customer Response</span></td>
                  <td>Request:<br>• Most recent eGFR result, OR<br>• Latest specialist letter with CKD details</td>
                  <td><strong>Reject</strong> if eGFR &lt;30 or Stage 4/5<br><br><strong>Prescribe</strong> if eGFR ≥30 or Stage 1/2/3</td>
                </tr>
              </table>
            </div>
          </details>
            ...
            <div class="accordion-body">
              ...
              <table class="protocol-table">
                ...
                <tr>
                  ...
                  <td>• Check SCR for cancer type and timeline<br>• Always require patient input<br>• Add tag: <span class="tag orange">Pending Customer Response</span></td>
                  <td>Ask if:<br>• Currently under oncology care?<br>• Cancer in remission?<br>• Request discharge/latest oncology letter</td>
                  <td><strong>Reject</strong> if active cancer/undergoing treatment<br><br><strong>Clinical decision</strong> if in remission (review oncology letter)</td>
                </tr>
                <tr>
                  <td><strong>Pregnancy</strong></td>
                  <td><a href="#macro-6" class="tag blue">Macro 6</a></td>
                  <td>• Always require confirmation<br>• Add tag: <span class="tag orange">Pending Customer Response</span></td>
                  <td>Ask if currently:<br>• Pregnant?<br>• Breastfeeding?<br>• Trying to conceive?</td>
                  <td><strong>Reject</strong> if pregnant, breastfeeding, or trying to conceive<br><br><strong>Prescribe</strong> if none of the above</td>
                </tr>
                <tr>
                  <td><strong>Dementia / Cognitive Impairment</strong></td>
                  <td><a href="#macro-7" class="tag blue">Macro 7</a></td>
                  <td>• Always require patient/carer input<br>• Add tag: <span class="tag orange">Pending Customer Response</span></td>
                  <td>Ask:<br>• Safe to use medication at home?<br>• Support available?<br>• Ability to self-administer?</td>
                  <td><strong>Clinical decision</strong> based on:<br>• Patient's ability to take medication safely<br>• Support network around patient</td>
                </tr>
                <tr>
                  ...
                  <td><strong>Reject</strong> if formal diagnosis confirmed<br><br><strong>Prescribe</strong> if no formal diagnosis</td>
                </tr>
                <tr>
                  <td><strong>Depression or Anxiety</strong><br><br><span style="font-size: 0.9em; color: #e74c3c;">Contraindication: acutely mentally unwell</span></td>
                  <td><a href="#macro-9" class="tag blue">Macro 9</a></td>
                  <td>• Check SCR entry date<br>• Check antidepressant start/dose change dates<br>• If &lt;3 months → hold + email<br>• Add tag: <span class="tag orange">Pending Customer Response</span></td>
                  <td>Request confirmation of:<br>• When condition added to SCR<br>• Any new antidepressants or dose changes in last 3 months</td>
                  <td><strong>Reject</strong> if entry &lt;3 months old<br>OR new antidepressant/dose increase in last 3 months<br><br><strong>Prescribe</strong> if ≥3 months</td>
                </tr>
                <tr>
                  <td><strong>Active Suicidal Ideation</strong></td>
                  <td><a href="#macro-9" class="tag blue">Macro 9</a></td>
                  <td>• Check SCR entry date<br>• If &lt;12 months → hold + email<br>• Add tag: <span class="tag orange">Pending Customer Response</span></td>
                ...
                <tr>
                  ...
                  <td>• Check SCR entry date<br>• If &lt;12 months or "current" → hold + email<br>• Add tag: <span class="tag orange">Pending Customer Response</span></td>
                  <td>Request confirmation of:<br>• When alcohol abuse was added to SCR<br>• Current alcohol use status</td>
                  <td><strong>Reject</strong> if &lt;12 months or current abuse<br><br><strong>Prescribe</strong> if ≥12 months and no current abuse</td>
                </tr>
              </table>
