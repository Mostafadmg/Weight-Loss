    ...
    return `
      <div class="scr-protocol">
        ...
        <div class="protocol-card">
          ...
          <details class="accordion">
            <summary>Time-sensitive conditions — when information is needed (Macro 1)</summary>
            <div class="accordion-body">
              <div class="protocol-text"><strong>Table 2:</strong> If timing is missing, email the patient (Macro 1). Reject when the timing falls within the contraindication window.</div>
              <table class="protocol-table">
                <tr><th>Condition</th><th style="width: 150px;">Relevant time-scale</th><th>Action</th></tr>
                <tr><td><strong>Bariatric Surgery:</strong><br>• Roux-en-Y Gastric Bypass (RYGB)<br>• Sleeve Gastrectomy<br>• Adjustable Gastric Band (Lap-Band)<br>• Biliopancreatic Diversion with Duodenal Switch (BPD/DS)<br>• Mini Gastric Bypass (OAGB – One Anastomosis Gastric Bypass)<br>• Endoscopic Bariatric Procedures (e.g., gastric balloon)</td><td>&lt;12 months</td><td><strong>Reject if under 12 months</strong><br><br>Prescribe if surgery was more than a year ago</td></tr>
                <tr><td><strong>Cholecystectomy</strong></td><td>&lt;12 months</td><td><strong>Reject if under 12 months</strong><br><br>Prescribe if surgery was more than a year ago</td></tr>
                <tr><td><strong>On Insulin</strong></td><td>Prescribed within the last 3 months as acute<br><br><strong>OR</strong><br><br>Present on list of repeat medication</td><td><strong>Reject</strong></td></tr>
                <tr><td><strong>On oral diabetic medication</strong><br>• Sulfonylureas (Diamicron, Daonil, Rastin)<br>• SGLT2 inhibitors (Jardiance, Forxiga, Invokana)<br>• DPP-4 inhibitors (Januvia, Galvus, Trajenta)<br>• Thiazolidinediones (Actos)</td><td>Prescribed within the last 3 months as acute<br><br><strong>OR</strong><br><br>Present on list of repeat medication</td><td><strong>Reject</strong></td></tr>
                <tr><td><strong>Medication with Narrow Therapeutic Index</strong><br>• Amiodarone<br>• Carbamazepine<br>• Ciclosporin<br>• Clozapine<br>• Digoxin<br>• Fenfluramine<br>• Lithium<br>• Mycophenolate mofetil<br>• Oral methotrexate<br>• Phenobarbital<br>• Phenytoin<br>• Somatrogon<br>• Tacrolimus<br>• Theophylline<br>• Warfarin</td><td>Prescribed within the last 3 months as acute<br><br><strong>OR</strong><br><br>Present on list of repeat medication</td><td><strong>Reject</strong></td></tr>
                <tr><td><strong>Orlistat</strong><br>• Alli<br>• Xenical</td><td>GLP prescription issued &lt;1 month</td><td><strong>Reject</strong><br><br>Concurrent use is a contraindication</td></tr>
              </table>
          ...
          <details class="accordion">
            <summary>Conditions where information is needed regarding clinical details (Macros 2 / 4 / 5)</summary>
            <div class="accordion-body">
              <div class="protocol-text"><strong>Table 3 (Section 4.2.2):</strong> If you do not have the relevant information, you must reach out to the patient to be able to make a decision.</div>
              <table class="protocol-table">
                <tr><th>Condition</th><th>Relevant information for decision</th><th>Action</th><th style="width: 180px;">Information needed</th></tr>
                <tr>
                  <td><strong>Cholelithiasis</strong><br>(gallstones)</td>
                  <td>No evidence of cholecystectomy</td>
                  <td>If no evidence, put on hold and gather more information.<br><br><strong>Reject if customer confirms no cholecystectomy</strong></td>
                  <td><strong>Macro 2</strong><br><br>Cholecystectomy should be confirmed with the patient if not visible on the SCR</td>
                </tr>
                <tr>
                  <td><strong>Cholecystitis</strong><br>(gallbladder inflammation)</td>
                  <td>No evidence of cholecystectomy</td>
                  <td>If no evidence, put on hold and gather more information.<br><br><strong>Reject if customer confirms no cholecystectomy</strong></td>
                  <td><strong>Macro 2</strong><br><br>Cholecystectomy should be confirmed with the patient if not visible on the SCR</td>
                </tr>
                <tr>
                  ...
                  <td>Stage IV</td>
                  <td>If there is no information on what stage they have, email the patient.<br><br><strong>Reject if customer confirms stage IV</strong></td>
                  <td><strong>Macro 4</strong><br><br>Last letter from their cardiologist stating stage or if fit for GLP1</td>
                </tr>
                <tr>
                  <td><strong>Chronic Kidney Disease (CKD)</strong></td>
                  <td>eGFR &lt;30<br><br>Stage 4</td>
                  <td>If there is no information on what their eGFR is or what stage they have, email the patient.<br><br><strong>Reject if eGFR is &lt;30</strong></td>
                  <td><strong>Macro 5</strong><br><br>Last eGFR</td>
                </tr>
              </table>
            </div>
          </details>
          ...
          <details class="accordion">
            ...
            <div class="accordion-body">
              ...
              <table class="protocol-table">
                <tr><th>Condition</th><th>Relevant information for decision</th><th>Action</th><th style="width: 180px;">Information needed</th></tr>
                <tr>
                  <td><strong>Any cancer diagnosis</strong><br>(excluding MEN2 or medullary thyroid cancer)</td>
                  <td>Active cancer currently undergoing treatment from an oncology team</td>
                  <td><strong>Information required in all cases</strong><br><br>See section below.</td>
                  <td><strong>Macro 3</strong></td>
                </tr>
                <tr>
                  <td><strong>Pregnancy</strong></td>
                  <td>Current pregnancy</td>
                  <td><strong>More information is needed in all cases</strong><br><br>Once the information is gathered, <strong>REJECT</strong> if currently pregnant, breastfeeding or trying to conceive, or <strong>APPROVE</strong> if none of the above</td>
                  <td><strong>Macro 6</strong></td>
                </tr>
                <tr>
                  <td><strong>Dementia / cognitive impairment</strong></td>
                  <td>Are they safe at home to use the medication?</td>
                  <td><strong>More information is needed in all cases</strong><br><br>Once the information is gathered, make a clinical decision to prescribe or reject according to the patient's ability to take the medication safely and support around the patient.</td>
                  <td><strong>Macro 7</strong></td>
                </tr>
                <tr>
                  <td><strong>Chronic malabsorption</strong></td>
                  <td>Any formal diagnosis</td>
                  <td><strong>More information is needed in all cases</strong><br><br>If the patient has a formal diagnosis, <strong>reject</strong> the prescription.</td>
                  <td><strong>Macro 8</strong></td>
                </tr>
                <tr>
                  <td><strong>Depression or Anxiety</strong><br><br>Contraindication - acutely mentally unwell</td>
                  <td>Added to SCR &lt;3 months ago<br><br>If the entry is older than 3 months, ok to prescribe<br><br>The use of antidepressants can be used as a proxy for this area as well</td>
                  <td><strong>Reject</strong> if under 3 months<br><strong>Prescribe</strong> if exactly 3 months or more<br><br><strong>Reject</strong> if new antidepressant or dose increase in the last 3 months<br><strong>Prescribe</strong> if new antidepressant medication or increased dose was exactly 3 months or more</td>
                  <td><strong>Macro 9</strong></td>
                </tr>
                <tr>
                  <td><strong>Active Suicidal ideation</strong></td>
                  <td>Added to SCR in the last year</td>
                  <td><strong>Reject</strong> if under 12 months<br><strong>Prescribe</strong> if exactly 12 months or more</td>
                  <td><strong>Macro 9</strong></td>
                </tr>
                <tr>
                  <td><strong>Current Alcohol abuse or dependence</strong></td>
                  <td>Added to SCR in the last year</td>
                  <td><strong>Reject</strong> if under 12 months or current alcohol abuse<br><strong>Prescribe</strong> if exactly 12 months or more</td>
                  <td><strong>Macro 10</strong></td>
                </tr>
              </table>
